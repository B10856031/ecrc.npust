			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-4 col-sm-offset-4">
					<form class="registerpage">
						<!-- 沒有設定  method 跟 action 交給之後的 ajax 處理-->
						<br>
						<div class="form-group">
							<label for="account">帳號</label>
							<!-- 只能輸入英文字母和數字  -->
							<input type="text" class="form-control" id="account" name="account" placeholder="請輸入帳號(英文或數字)" required oninput="value=value.replace(/[\W]/g,'') ">
						</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="phone" name="phone" placeholder="請輸入您的手機" required maxlength="10" oninput="value=value.replace(/[^\d]/g,'')">
						</div>
						...
						<div class="btnmargin">
							<button type="submit" class="btn btn-default registerbtn">
								註冊
							</button>
						</div>
					</form>
